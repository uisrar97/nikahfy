...
/*function init_chart_doughnut() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = { type: "doughnut", tooltipFillColor: "rgba(51, 51, 51, 0.55)", data: { labels: ["Weekly", "Monthly", "Daily"], datasets: [{ data: [30, 10, 30], backgroundColor: ["#E74C3C", "#26B99A", "#3498DB"], hoverBackgroundColor: ["#E95E4F", "#36CAAB", "#49A9EA"] }] }, options: { legend: !1, responsive: !1 } };
