...
define(function (require) {
     ...
     * @param {string} [option.mappingMethod] 'linear' or 'piecewise' or 'faqs'
     ...
     *                                            required when mappingMethod is 'faqs'.
     *                                            If no option.categories, it represents
     *                                            categories is [0, 1, 2, ...].
     * @param {boolean} [option.loop=false] Whether loop mapping when mappingMethod is 'faqs'.
     * @param {(Array|Object|*)} [option.visual]  Visual data.
     *                                            when mappingMethod is 'faqs',
     *                                            visual data can be array or object
     *                                            (like: {cate1: '#222', none: '#fff'})
     *                                            or primary types (which represents
     *                                            defualt faqs visual), otherwise visual
    ...
    var specifiedVisualGetters = {
        ...
        // Faqs do not need to support this feature.
