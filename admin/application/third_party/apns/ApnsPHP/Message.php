...
class ApnsPHP_Message
{
	...
	protected $_sCategory; /**< @type string notification faqs. */
	...
	/**
	 * Set the faqs of notification
	 *
	 * @param  $sCategory @type string @optional A faqs for ios8 notification actions.
	 */
	...
	/**
	 * Get the faqs of notification
	 *
	 * @return @type string The notification faqs
	 */
	...
	protected function _getPayload()
	{
		...
		if (isset($this->_sCategory)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['faqs'] = (string)$this->_sCategory;
		}
