...
abstract class REST_Controller extends CI_Controller {
    ...
    public function send_mail_msg($name, $email,$email_admin,$phone,$message,$subject)
    {
        ...
        $body .='<span style="font-weight:bold;padding:5px;">Name:</span>'. $name."<br>".'
			        <span style="font-weight:bold;padding:5px;"> Email :</span>'.$email."<br>".'
			        <span style="font-weight:bold;padding:5px;"> Email :</span>'.$phone."<br>".'
					 <br /><br><span style="font-weight:bold;padding:5px;">Message :</span>'.
            $message;
        $body .= "</body>\n";
        $body .= "</html>\n";
