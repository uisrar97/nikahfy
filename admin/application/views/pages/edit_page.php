        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form role="form" id="edit_page" action="<?= base_url(); ?>pages/edit_page_process" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">

                                <div class="form-group">
                                    <label for="page_title"><?php echo $this->lang->line('pagetitle')?> <span style="color: #FF0000;">*</span></label>
                                    <input type="text" id="page_title" class="form-control" name="page_title" placeholder="Page Title" value="<?= $page['page_title']; ?>"/>
                                    <input type="hidden" name="page_id" readonly value="<?= $page['page_id']; ?>" />
                                    <input type="hidden" name="old_page_title" readonly value="<?= $page['page_title']; ?>" />
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="meta_title" class="form-control" name="meta_title" placeholder="SEO Title" value="<?= $page['meta_title']; ?>" />
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="page_details" class="form-control" name="page_details" placeholder="page Details"><?= $page['page_details']; ?></textarea>
