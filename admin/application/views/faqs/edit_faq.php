            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form role="form" id="edit_page" action="<?= base_url(); ?>Faqs/update_faq" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="page_title"><?= $this->lang->line('title')?> <span style="color: #FF0000;">*</span></label>
                                    <input type="text" value="<?= $cat->cname?>" id="cname" class="form-control" name="cname" placeholder="<?= $this->lang->line('title')?>" />
                                    <input type="hidden" value="<?= $cat->id?>" id="id" class="form-control" name="cid" placeholder="<?= $this->lang->line('title')?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="page_details" class="form-control" name="cat_detail" placeholder="<?= $this->lang->line('desc')?>"><?= $cat->cat_detail?></textarea>
