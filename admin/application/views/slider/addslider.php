    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 class="main"><?php echo $this->lang->line('addslider')?></h2>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="addslider" method="post" action="<?php echo base_url().'Slider/save'?>" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="page_title"><?= $this->lang->line('slidertitle')?> <span style="color: #FF0000;">*</span></label>
                                    <input type="text" id="title" class="form-control" name="title" placeholder="<?= $this->lang->line('slidertitle')?>" />
                                </div>
                            </div>
									...
									<div class="col-md-6">
										...
										<input type="text" id="project_img_1"  class="form-control " name="sliderimage" readonly required   placeholder="<?= $this->lang->line('sliderimage')?>" />
										...
										<label>&nbsp;</label>
										<div class="clearfix"></div>
										<a href="<?php echo base_url(); ?>assets/plugins/responsive_filemanager/filemanager/dialog.php?type=1&field_id=project_img_1" class="btn btn-default iframe-btn" type="button">Select File</a>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="page_details" class="form-control" name="desc" placeholder="Description"></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="btn btn-primary send" type="submit" value="<?= $this->lang->line('addslider')?>" />
                                </div>
                            </div>
                        </form>
