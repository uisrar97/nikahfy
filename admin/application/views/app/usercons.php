	...
	<div class="">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2 class="main">User Connections</h2>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('body').on('click','.view',function () {
            var id= $(this).attr('id');
            location.href=base_url+'admin/Dashboard/viewCons/'+id;
        });
        $('#datatable-responsive').DataTable({
            ...
            "scrollX": true,
            "ajax":{
                "url": base_url+"app/Usercons/get_usercons",
                "processing" : true,
                "serverside" : false,
                "dataType": "json",
                "deferRender": true,
        ...
        $('body').on('click','.deleted',function (e) {
            ...
            $.ajax({
                url:"<?php echo base_url().'app/Usercons/app_user_del/'?>",
                type:"POST",
                data:{id:id},
                success:function(res) {
                    if(res!="false"){
        ...
        $('body').on('click','.disapp',function (e) {
           ...
           // $('.bs-example-modal-sm').modal('hide');
            $.ajax({
                url:"<?php echo base_url().'app/Usercons/Deactivate'?>",
                type:"POST",
                data:{id:id},
                success:function(res) {
                    if(res!="false"){
        ...
        $('body').on('click','.app',function (e) {
            ...
            // $('.bs-example-modal-sm').modal('hide');
            $.ajax({
                url:"<?php echo base_url().'app/Usercons/Activate'?>",
                type:"POST",
                data:{id:id},
                success:function(res) {
                    if(res!="false"){
