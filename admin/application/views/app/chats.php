...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('body').on('click','.view',function () {
            var id= $(this).attr('id');
            location.href=base_url+'admin/Dashboard/viewChats/'+id;
        });
        $('#datatable-responsive').DataTable({
            ...
            "scrollX": true,
            "ajax":{
                "url": base_url+"app/Chats/get_appusers",
                "processing" : true,
                "serverside" : false,
                "dataType": "json",
                "deferRender": true,
        ...
        $('body').on('click','.disapp',function (e) {
           ...
           // $('.bs-example-modal-sm').modal('hide');
            $.ajax({
                url:"<?php echo base_url().'app/Chats/Deactivate'?>",
                type:"POST",
                data:{id:id},
        ...
        $('body').on('click','.app',function (e) {
            ...
            // $('.bs-example-modal-sm').modal('hide');
            $.ajax({
                url:"<?php echo base_url().'app/Chats/Activate'?>",
                type:"POST",
                data:{id:id},
                success:function(res) {
                    if(res!="false"){
