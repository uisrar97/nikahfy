...
<div style="width:600px; background:#333; margin:0 auto;">
    <div style="text-align:center; padding:20px 0"><a href="#" ><img src="<?=base_url().'assets/images/logo.png'?>"> </a></div>



    <div style="background-color:#fff">
        <p style="padding:25px 25px 5px; margin:0; text-align:left; line-height:30px; font-size:16px; font-family: 'Open Sans', sans-serif; font-weight:600; text-decoration:none ">Dear </p>



        <p style="padding:0 25px 5px; margin:0; text-align:left; line-height:20px; font-size:12px; font-family: 'Open Sans', sans-serif; text-decoration:none;    color: #333;">Email: <?php //echo $email?></p>
        <p style="padding:0 25px 5px; margin:0; text-align:left; line-height:30px; font-size:12px; font-family: 'Open Sans', sans-serif;color: #333; "><?php //echo $MSG?></p>


        <p style="padding: 0px 25px 5px; font-family: 'Open Sans', sans-serif; font-size:14px; font-weight:700">  Thanks <br><span>  Nikahfy  </span> </p>
        ...
        <div style="background:#333; padding:12px 0">
            <div class="footerlogo" style="text-align:center;margin-top: -30px;margin-bottom: 5px;"><img src="<?=base_url().'assets/images/logo.png'?>" style="width:140px;">   </div>
            ...
            <div style="text-align:center; margin-top:7px; border-top:1px solid #fff; border-bottom:1px solid #fff; padding:4px 0px;    margin-left: 25px;margin-right: 25px;">
                ...
                <!--          <a href="#" style="color:#fff; text-decoration:none; font-size:10px; padding:0 6px; font-family: 'Open Sans', sans-serif;">Pricing </a> <a href="#" style="color:#fff; text-decoration:none; font-size:10px; padding:0 6px;  font-family: 'Open Sans', sans-serif"> Faqs </a>-->
            ...
            <div class="footer-copyright" style="color:#FFF;margin-top: 10px;margin-bottom: -30px; text-align:center;    font-family: 'Open Sans', sans-serif; font-size:8px;">
                <i class="fa fa-copyright" aria-hidden="true"></i> Copyrights &copy; <?php echo date('Y')?> Nikahfy. All Rights Reserved.
            </div>
