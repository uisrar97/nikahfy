            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="addslider" method="post" action="<?php echo base_url().'cms/Services/update'?>" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="page_title"><?= $this->lang->line('title')?> <span style="color: #FF0000;">*</span></label>
                                    <input type="text" id="name" class="form-control" name="name" placeholder="<?= $this->lang->line('desc')?>" value="<?= $ser->name?>" />
                                    <input type="hidden" id="id" class="form-control" name="id" placeholder="Service Title" value="<?= $ser->id?>"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="col-md-9 col-xs-7 text-left" style="padding-left: 0px">
                                    <div class="form-group">
                                        <label for="video1">Image</label>
                                        <input type="text" id="project_img_1"  class="form-control " name="sliderimage" readonly required   placeholder="Slider" value="<?= $ser->image?>" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="page_details" class="form-control" name="desc" placeholder="<?= $this->lang->line('desc')?>"><?= $ser->content?></textarea>
