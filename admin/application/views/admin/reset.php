...
/*            if (isset($_COOKIE["centersquare_username"]))
         ...
         <!--   <form class="login100-form validate-form" id="check_user" method="post" action="<?php /*echo base_url().''*/?>">-->
                ...
                <form role="form" id="reset" action="<?php echo base_url('Reset'); ?>" method="post" enctype="multipart/form-data">
                    <div class="wrap-input100 validate-input" data-validate = "Enter password">
                        <input class="input100" type="password" name="password" placeholder="New Password" id="password" required/>
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate = "Enter password">
                        <input class="input100" type="password" name="confirmpassword" placeholder="Re-Enter New Password" id="confirmpassword" required/>
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>
