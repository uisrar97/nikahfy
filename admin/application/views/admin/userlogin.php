...
/*            if (isset($_COOKIE["centersquare_username"]))
         ...
         <!--   <form class="login100-form validate-form" id="check_user" method="post" action="<?php /*echo base_url().''*/?>">-->
                ...
                <div class="wrap-input100 validate-input" data-validate = "Enter username">
                    <input class="input100" type="text" name="username" placeholder="Email / Username" id="username" onKeyPress="enterpress(event)" />
                    <span class="focus-input100" data-placeholder="&#xf207;"></span>
                </div>

                <div class="wrap-input100 validate-input" data-validate="Enter password">
                    <input class="input100" type="password" name="password" placeholder="Password" id="password" onKeyPress="enterpress(event)" />
                    <span class="focus-input100" data-placeholder="&#xf191;"></span>
                </div>
                <div class="wrap-input100 imp" style="border-bottom: none;">
                        <p style="text-align: center;" class="ppp"><?php echo $captcha['image']; ?></p>
                </div>
                 <div class="wrap-input100 validate-input" data-validate="Security Code">
                    <input class="input100" type="text" name="captcha_code" placeholder="Security Code" utocomplete="off" id="captcha_code" onKeyPress="enterpress(event)" />
                    <span class="focus-input100" data-placeholder="&#xf191;"></span>
                </div>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn send">
                        Login
                    </button>
                </div>
   ...
   /* $(window).load(function(){
    ...
    $(document).ready(function(){
        ...
        $('body').on('click','.send',function(){
            ...
            $.ajax({
                url: base_url+'Loginuser/check_user',
                method:"post",
                dataType:"json",
                data:{username:name,password:pass,captcha_code:cap},
