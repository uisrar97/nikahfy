    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 class="main"><?= $this->lang->line('addsection')?></h2>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form role="form" id="edit_page" action="<?= base_url(); ?>Sections/save_section" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="page_title"><?= $this->lang->line('sectionname')?> <span style="color: #FF0000;">*</span></label>
                                    <input type="text" id="page_title" class="form-control" name="page_title" placeholder="<?= $this->lang->line('sectionname')?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="page_details" class="form-control" name="page_details" placeholder="<?= $this->lang->line('sectiondetail')?>"></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="btn btn-primary" type="submit" value="<?= $this->lang->line('addsection')?>" />
                                </div>
                            </div>
                        </form>
