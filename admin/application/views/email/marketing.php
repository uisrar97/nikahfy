...
<!-- page content -->
<link rel="stylesheet" href="<?php base_Url();?>assets/css/chosen.min.css" />
<script rel="text/javascript" href="<?php base_Url();?>assets/js/chosen.jquery.min.js"></script>
<script rel="text/javascript" href="<?php base_Url();?>assets/js/jquery-3.4.1.min.js"></script>
	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2 class="main">Send Email to Marketing Team</h2>
					...
					<div class="x_content">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form role="form" id="marketing_email" action="<?php echo base_url('send-market-email');?>" method="post" enctype="multipart/form-data">
                                <div class="clearfix"></div>
                                <div class="col-md-12">
                                    <label>Marketing Team Name</label>
                                    <br>
                                    <select id="market" class="form-control" onchange="myFunction(event)">
                                        <option value="">Select an Option</option>
                                        <?php
                                            foreach($market as $val)
                                            {
                                                $value = $val->Name;
                                                echo "<option value=' $val->email'>$val->Name</option>";
                                            }
                                        ?>
                                    </select>
                                    <br>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <input id='market_email' name="to" class='form-control' value='Select An Option First'/>
                                    <br>
                                </div>
                                <div class="col-md-12">
                                    <label>Cc</label>
...
<script>
    ...
    function myFunction(e) 
    {
        ...
        document.getElementById("market_email").value = emails;
    }
    </script>