...
class Heidelpay implements HeidelpayParentInterface
{
     ...
     * @return Heidelpay
     */
    public function setDebugHandler(DebugHandlerInterface $debugHandler)
    {
     ...
     * {@inheritDoc}
     */
    public function getUri($appendId = true)
    {
        return '';
    }
     ...
     */
    public function getResource(AbstractHeidelpayResource $resource)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchPaymentByOrderId($orderId)
    {
     ...
     * @throws RuntimeException
     */
    public function createBasket(Basket $basket)
    {
     ...
     * @throws RuntimeException
     */
    public function fetchBasket($basket)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function createPaymentType(BasePaymentType $paymentType)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchCustomerByExtCustomerId($customerId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchAuthorization($payment)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchChargeById($paymentId, $chargeId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchCharge(Charge $charge)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchReversalByAuthorization($authorization, $cancellationId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchReversal($payment, $cancellationId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchRefundById($payment, $chargeId, $cancellationId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchRefund(Charge $charge, $cancellationId)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function fetchShipment($payment, $shipmentId)
    {
     ...
     * @throws RuntimeException
     */
    public function fetchWebhook($webhook)
    {
     ...
     * @throws RuntimeException
     */
    public function registerMultipleWebhooks(string $url, array $events)
    {
     ...
     * @throws RuntimeException
     */
    public function fetchResourceFromEvent()
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function chargeAuthorization($payment, $amount = null)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function chargePayment($payment, $amount = null, $currency = null)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function cancelAuthorization(Authorization $authorization, $amount = null)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function cancelAuthorizationByPayment($payment, $amount = null)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function cancelChargeById($paymentId, $chargeId, $amount = null)
    {
     ...
     * @throws RuntimeException      A RuntimeException is thrown when there is a error while using the SDK.
     */
    public function ship($payment, $invoiceId = null)
    {
