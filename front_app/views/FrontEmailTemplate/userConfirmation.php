...
<div style="width:600px; background:linear-gradient(45deg, #8a0240 0%, #c9216f 100%); margin:0 auto;">
    ...
    <div style="background-color:#fff">
        <p style="padding:25px 25px 5px; margin:0; text-align:left; line-height:30px; font-size:16px; font-family: 'Open Sans', sans-serif; font-weight:600; text-decoration:none ">Dear,<?php $rcd[0]->fname.' '.$rcd[0]->lname?></p>

        <p style="padding:0 25px 5px; margin:0; text-align:left; line-height:20px; font-size:12px; font-family: 'Open Sans', sans-serif; text-decoration:none;    color: #333;">Your transction is Successfully submitted. we will be get back as soon as:</p>
