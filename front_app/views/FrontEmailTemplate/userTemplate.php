...
<div style="width:600px; background:linear-gradient(45deg, #8a0240 0%, #c9216f 100%); margin:0 auto;">
    ...
    <div style="background-color:#fff">
        ...
        <p style="padding:0 25px 5px; margin:0; text-align:left; line-height:30px; font-size:12px; font-family: 'Open Sans', sans-serif;color: #333; ">Thankyou for trying to contact with us. We at MountexGroup Mobile will get back to you shortly.</p>
      ...
      <!--          <a href="#" style="color:#fff; text-decoration:none; font-size:10px; padding:0 6px; font-family: 'Open Sans', sans-serif;">Pricing </a> <a href="#" style="color:#fff; text-decoration:none; font-size:10px; padding:0 6px;  font-family: 'Open Sans', sans-serif"> Faqs </a>-->
            ...
            <div class="footer-copyright" style="color:#FFF;margin-top: 10px;margin-bottom: -30px; text-align:center;    font-family: 'Open Sans', sans-serif; font-size:8px;">
                <i class="fa fa-copyright" aria-hidden="true"></i> Copyrights &copy; <?php echo date('Y')?> MountexGroup App. All Rights Reserved.
            </div>
