...
<div style="width:600px; background:linear-gradient(45deg, #8a0240 0%, #c9216f 100%); margin:0 auto;">
    ...
    <div style="background-color:#fff">
        <p style="padding:25px 25px 5px; margin:0; text-align:left; line-height:30px; font-size:16px; font-family: 'Open Sans', sans-serif; font-weight:600; text-decoration:none ">Dear <?php echo $full_name?>,</p>
        <p style="padding:0 25px 5px; margin:0; text-align:left; line-height:30px; font-size:12px; font-family: 'Open Sans', sans-serif;color: #333; ">Thankyou for trying to contact with us. We at MountexGroup will get back to you shortly.</p>
        <p style="padding: 0px 25px 5px; font-family: 'Open Sans', sans-serif; font-size:14px; font-weight:700">  Regards, <br>
            <span> MountexGroup  </span> </p>
